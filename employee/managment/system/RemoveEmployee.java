...
public class RemoveEmployee extends JFrame implements ActionListener {
    ...
    RemoveEmployee() {
        ...
        labelempId.setFont(new Font("Raleway",Font.BOLD,18));
        ...
        labelphone.setFont(new Font("Raleway",Font.BOLD,18));
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/remove2.jpg"));
